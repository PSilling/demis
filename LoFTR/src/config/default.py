...
# DEMIS options
_CN.DATASET.DEMIS_IMG_RESIZE = 512  # resize the longer side, zero-pad bottom-right to square.
_CN.DATASET.DEMIS_IMG_PAD = True  # pad img to square with size = DEMIS_IMG_RESIZE
_CN.DATASET.DEMIS_DEPTH_PAD = True  # pad depthmap to square with size = 1024
_CN.DATASET.DEMIS_DF = 8
