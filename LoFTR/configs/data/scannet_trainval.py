...
TRAIN_BASE_PATH = "assets/scannet_test_1500"
cfg.DATASET.TRAINVAL_DATA_SOURCE = "ScanNet"
cfg.DATASET.TRAIN_DATA_ROOT = "../../../datasets/scannet/scannet_test_1500"
cfg.DATASET.TRAIN_NPZ_ROOT = TRAIN_BASE_PATH
cfg.DATASET.TRAIN_LIST_PATH = f"{TRAIN_BASE_PATH}/scannet_test.txt"
...
cfg.DATASET.VAL_DATA_ROOT = cfg.DATASET.TEST_DATA_ROOT = "../../../datasets/scannet/scannet_test_1500"
